...
text = ("Проанализируй файл, найди и прочитай поле Комментарий,"
        "есть 3 варианта развития событий:"
        "если в поле Комментарий не встречается символ \"/\" - значит это 1 вариант - взять ТОЛЬКО первое слово целиком как last_name_1, last_name_2 == null, last_name_3 == null, ВСЕ последующие слова игнорировать,"
        "если в поле Комментарий встречается 1 символ \"/\" - значит это 2 вариант - взять последнее слово перед символом \"/\" как last_name_1, и первое слово после символа \"/\" как last_name_2, last_name_3 == null,"
        "если в поле Комментарий встречается 2 символа \"/\" - значит это 3 вариант - взять последнее слово перед первым символом \"/\" как last_name_1, взять последнее слово перед вторым символом \"/\" как last_name_2, и первое слово после второго символа \"/\" как last_name_3,"
...
async def extract_employee_names(image_bytes: bytes) -> dict:
    """
